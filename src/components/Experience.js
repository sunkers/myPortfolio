    ...
    <div className={container}>
      ...
      <div className={experienceContainer}>
        <div className={experienceRow}>
          ...
          <div className={experienceDescription}>
            <p className={descriptionText}>
              Développement d'une application web de gestion de projet en
              Angular et Symfony
            </p>
          </div>
        </div>
        ...
        <div className={experienceRow}>
          ...
          <div className={experienceDescription}>
            <p className={descriptionText}>
              En fondant un site éducatif sur la blockchain, j'ai démontré mon
              expertise technique, mes compétences entrepreneuriales et ma
              passion pour rendre la technologie accessible à tous.
            </p>
          </div>
        </div>
      </div>
